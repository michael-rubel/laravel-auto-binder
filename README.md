...
This package automatically creates binds the interfaces to its implementations in the Service Container, scanning the project folders. This helps avoid manually registering container bindings when the project needs to bind a lot of interfaces to its implementations without any additional dependencies.
